...
format:
  revealjs:
    ...
    logo-width: 200px
    footer: "**C**ognitive **N**euroscience **S**eminars"
from: markdown+emoji  
...
2.  It quantifies the posterior probability that the null hypothesis is true given the data, as well as the posterior probability that the alternative hypothesis is true given the data.
...
> Have you ever come across the claim that Bayesian models are immune to multiplicity problems?
