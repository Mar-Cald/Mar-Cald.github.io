...
1.  **Calderan, M.**, Toffalini, E., Mirandola, C., & Cellini, N.
...
2.  Toffoli, L., **Calderan, M.**, Del Popolo Cristaldi, F., Duma, G.
    ...
    <https://doi.org/10.1037/dev0001976>.**OSF** repo:
    <https://osf.io/shuq2/> \[IF: 3.1, Quartile: Q2\]
...
4.  **Calderan, M.**, & Visalli, A. (2024). Challenges of meta-learning
...
\cvsubsection{Accepted for Publication}
...
1.  **Calderan, M.**, Jongkees, J.B., Gambarota, F., Pastore, M.,
    ...
    <https://doi.org/10.1525/collabra.140750>, **OSF** repo:
    \href{https://osf.io/d43vs/}{https://osf.io/d43vs/} \[IF: 3.1,
    Quartile: Q1\]
...
7.  **Calderan, M.**, Visalli, A., Sellaro, R., & Cellini, N. The Eﬀects
...
-   English \texttwemoji{flag: United Kingdom}
    \texttwemoji{flag: United States}: Upper Intermediate
