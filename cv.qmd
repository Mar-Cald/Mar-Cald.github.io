...
cvevents <- function(tbl, when, what, where, details = NULL) {
  ...
  for (i in seq_len(nrow(tbl))) {
    block <- '<div style="display: flex; justify-content: space-between; margin-bottom: 1.5em;">\n'
    
    # Left side
    block <- paste0(block, '  <div style="width: 80%;">\n')
    ...
    block <- paste0(
      block,
      '  <div style="width: 18%; text-align: right; font-weight: bold;">',
      tbl[[when]][i],
      '</div>\n'
    )
